...
var registro = exports.registro = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, id, nombre, telefono, correo, roll, contrasena, clave, repp, hash, claveCifrada, respuesta;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          ...
          claveCifrada = hash;
          _context.next = 16;
          return _db.db.query("CALL SP_REGISTRAR_USER('".concat(id, "', '").concat(nombre, "',\n        '").concat(telefono, "', '").concat(correo, "', '").concat(claveCifrada, "', '").concat(roll, "')"));
        case 16:
...
var loguear = exports.loguear = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, correo, contrasena, repp, _compare, respuesta, match, pyload, token;
